...
(function (y) {
  ...
  function G(a, b) {
    b = b || Error;return function () {
      var d = arguments[0],
          c;c = "[" + (a ? a + ":" : "") + d + "] http://errors.angularjs.org/1.5.11/" + (a ? a + "/" : "") + d;for (d = 1; d < arguments.length; d++) {
    ...
    var c, f;if (a) if (C(a)) for (c in a) {
    ...
    } else if (a.forEach && a.forEach !== q) a.forEach(b, d, a);else if (xc(a)) for (c in a) {
      b.call(d, a[c], c, a);
    ...
    return null !== a && "object" === (typeof a === "undefined" ? "undefined" : _typeof(a)) && !Bc(a);
  }function D(a) {
    ...
    if (a === b) return !0;if (null === a || null === b) return !1;if (a !== a && b !== b) return !0;var d = typeof a === "undefined" ? "undefined" : _typeof(a),
      ...
      if (ja(a)) return ja(b) ? na(a.getTime(), b.getTime()) : !1;if (Za(a)) return Za(b) ? a.toString() === b.toString() : !1;if (ab(a) || ab(b) || Ya(a) || Ya(b) || I(b) || ja(b) || Za(b)) return !1;d = V();for (c in a) {
        if ("$" !== c.charAt(0) && !C(a[c])) {
    ...
    E(d) || (d = {});d = R({ strictDi: !1 }, d);var c = function c() {
      a = F(a);if (a.injector()) {
    ...
    d && I(a) && (a = a[a.length - 1]);gb(C(a), b, "not a function, got " + (a && "object" === (typeof a === "undefined" ? "undefined" : _typeof(a)) ? a.constructor.name || "Object" : typeof a === "undefined" ? "undefined" : _typeof(a)));return a;
  }function Ra(a, b) {
    ...
    var d,
      ...
      d.innerHTML = c[1] + a.replace($f, "<$1></$2>") + c[2];for (c = c[0]; c--;) {
        d = d.lastChild;
      }e = cb(e, d.childNodes);d = f.firstChild;d.textContent = "";
    ...
    b || ib(a);if (a.querySelectorAll) for (var d = a.querySelectorAll("*"), c = 0, f = d.length; c < f; c++) {
      ib(d[c]);
    }
  }function Wc(a, b, d, c) {
  ...
  function cg(a, b) {
    ...
    var d = function d(c, _d) {
      c.isDefaultPrevented = function () {
        ...
        };var k = e.specialHandlerWrapper || eg;1 < g && (e = ka(e));for (var l = 0; l < g; l++) {
    ...
    var d = a && a.$$hashKey;if (d) return "function" === typeof d && (d = a.$$hashKey()), d;d = typeof a === "undefined" ? "undefined" : _typeof(a);return d = "function" === d || "object" === d && null !== a ? a.$$hashKey = d + ":" + (b || ke)() : d + ":" + a;
  }function Sa(a, b) {
    if (b) {
    ...
    function d(a) {
      ...
      function d(b, e) {
        ...
        }, get: d, annotate: fb.$$annotate, has: function has(b) {
      ...
      function a(a, c) {
        function f(a) {
          ...
          a !== b && (a && (a.p = b), b && (b.n = a));
            ...
            m = V(),
            n = null,
            r = null;return b[a] = { put: function put(a, b) {
            if (!z(b)) {
      ...
      function P() {
        ...
        a instanceof F || (a = F(a));for (var f = /\S+/, g = 0, h = a.length; g < h; g++) {
          ...
          gb(b, "scope");e && e.needsNewScope && (b = b.$parent.$new());d = d || {};var f = d.parentBoundTranscludeFn,
              g = d.transcludeControllers;d = d.futureParentElement;f && f.$$boundTransclude && (f = f.$$boundTransclude);m || (m = (d = d && d[0]) ? "foreignobject" !== wa(d) && ma.call(d).match(/SVG/) ? "svg" : "html" : "html");d = "html" !== m ? F(ha(m, F("<div>").append(a).html())) : c ? Pa.clone.call(a) : a;if (g) for (var h in g) {
            d.data("$" + h + "Controller", g[h].instance);
          }ca.$$addScopeInfo(d, b);c && c(d, b);l && l(b, d, d, f);return d;
        };
      }function Ma(a, b, c, d, e, f) {
        function g(a, c, d, e) {
          var f, k, l, m, n, s, A;if (p) for (A = Array(c.length), m = 0; m < h.length; m += 3) {
            f = h[m], A[f] = c[f];
          } else A = c;m = 0;for (n = h.length; m < n;) {
        ...
        var f = c.$attr,
            ...
            }"input" === g && "hidden" === a.getAttribute("type") && a.setAttribute("autocomplete", "off");if (!Fa) break;f = a.className;E(f) && (f = f.animVal);if (D(f) && "" !== f) for (; a = h.exec(f);) {
              k = Da(a[2]), U(b, k, "C", d, e) && (c[k] = Y(a[3])), f = f.substr(a.index + a[0].length);
            }break;case La:
            if (11 === Ia) for (; a.parentNode && a.nextSibling && a.nextSibling.nodeType === La;) {
        ...
        function m(a, b, c, d) {
          ...
          });p = 0;for (v = h.length; p < v; p++) {
            B = h[p], sa(B, B.isolateScope ? M : e, P, g, B.require && X(B.directiveName, B.require, P, J), S);
          }var qa = e;u && (u.template || null === u.templateUrl) && (qa = M);a && a(qa, f.childNodes, void 0, l);for (p = k.length - 1; 0 <= p; p--) {
            B = k[p], sa(B, B.isolateScope ? M : e, P, g, B.require && X(B.directiveName, B.require, P, J), S);
          }q(J, function (a) {
        ...
        } else if (I(b)) for (e = [], g = 0, f = b.length; g < f; g++) {
          e[g] = X(a, b[g], c, d);
        ...
        var g = oa(a, e),
            h = k[e] || f,
            l = b(d, !f, g, h);if (l) {
          if ("multiple" === e && "select" === wa(a)) throw fa("selmulti", ya(a));c.push({ priority: 100, compile: function compile() {
        ...
        }f && f.replaceChild(c, d);a = y.document.createDocumentFragment();for (g = 0; g < e; g++) {
          a.appendChild(b[g]);
        ...
        function g(b, c, e) {
          ...
          Fa = p,
          xa = H,
          da;t.prototype = { $normalize: Da, $addClass: function $addClass(a) {
          ...
          var f = Zc(this.$$element[0], a),
            ...
            for (var f = "", g = Y(b), k = /(\s+\d+x\s*,|\s+\d+w\s*,|\s+,|,\s+)/, k = /\s/.test(g) ? k : /(,)/, g = g.split(k), k = Math.floor(g.length / 2), l = 0; l < k; l++) {
              var m = 2 * l,
                  f = f + S(Y(g[m]), !0),
                  f = f + (" " + Y(g[m + 1]));
            }g = Y(g[2 * l]).split(/\s/);f += S(Y(g[0]), !0);2 === g.length && (f += " " + Y(g[1]));this[a] = b = f;
    ...
    function e(a, b, d) {
      a = a.replace("JSON_CALLBACK", b);var e = f.createElement("script"),
        ...
        e.removeEventListener("load", _m, !1);e.removeEventListener("error", _m, !1);f.body.removeChild(e);e = null;var g = -1,
            s = "unknown";a && ("load" !== a.type || c.wasCalled(b) || (a = { type: "error" }), s = a.type, g = "error" === a.type ? 404 : 200);d && d(g, s);
      };e.addEventListener("load", _m, !1);e.addEventListener("error", _m, !1);f.body.appendChild(e);return _m;
      ...
      function e(a) {
        ...
        function r(a) {
          ...
          var A;k || (k = g(e), A = ha(k), A.exp = e, A.expressions = [], A.$$watchDelegate = h);return A;
            ...
            L = 0,
            O = [],
            M = [];A = e.length;for (var J = [], B = []; L < A;) {
          if (-1 !== (v = e.indexOf(a, L)) && -1 !== (q = e.indexOf(b, v + l))) L !== v && J.push(g(e.substring(L, v))), L = e.substring(v + l, q), O.push(L), M.push(d(L, r)), L = q + m, B.push(J.length), J.push("");else {
          ...
          }, { exp: e, expressions: O, $$watchDelegate: function $$watchDelegate(a, b) {
    ...
    var a = V(),
      ...
      function g(c, d, f) {
        var g, k, H;f = f || K;switch (typeof c === "undefined" ? "undefined" : _typeof(c)) {case "string":
        ...
        b.$$watchDelegate = a.$$watchDelegate;b.assign = h(a.assign);b.constant = a.constant;b.literal = a.literal;for (var c = 0; a.inputs && c < a.inputs.length; ++c) {
          a.inputs[c] = h(a.inputs[c]);
        }b.inputs = a.inputs;return b;
      }function k(a, b) {
        return null == a || null == b ? a === b : "object" === (typeof a === "undefined" ? "undefined" : _typeof(a)) && (a = lc(a), "object" === (typeof a === "undefined" ? "undefined" : _typeof(a))) ? !1 : a === b || a !== a && b !== b;
    ...
    function d() {
    ...
    }var n = G("$q", TypeError);R(c.prototype, { then: function then(a, b, c) {
      ...
      } });R(g.prototype, { resolve: function resolve(a) {
        ...
        null === f && (f = h.defer(function () {
          ...
          function c(a) {
            e = a;var b, d, g, h;if (!z(e)) {
              if (E(e)) {
                if (la(e)) for (f !== n && (f = n, s = f.length = 0, l++), a = e.length, s !== a && (l++, f.length = s = a), b = 0; b < a; b++) {
                  h = f[b], g = e[b], d = h !== h && g !== g, d || h === g || (l++, f[b] = g);
                } else {
                  f !== r && (f = r = {}, s = 0, l++);a = 0;for (b in e) {
          ...
          h.$$checkUrlChange();this === K && null !== f && (h.defer.cancel(f), u());c = null;do {
            p = !1;q = this;for (r = 0; r < A.length; r++) {
              ...
              if (r = q.$$watchers) for (r.$$digestWatchIndex = r.length; r.$$digestWatchIndex--;) {
                try {
              ...
              }if (!(r = q.$$watchersCount && q.$$childHead || q !== this && q.$$nextSibling)) for (; q !== this && !(r = q.$$nextSibling);) {
                q = q.$parent;
              }
            } while (q = r);if ((p || A.length) && !s--) throw K.$$phase = null, d("infdig", b, t);
          } while (p || A.length);for (K.$$phase = null; L < v.length;) {
            try {
              v[L++]();
            } catch (y) {
              e(y);
          ...
          if (!this.$$destroyed) {
            var a = this.$parent;this.$broadcast("$destroy");this.$$destroyed = !0;this === K && h.$$applicationDestroyed();r(this, -this.$$watchersCount);for (var b in this.$$listenerCount) {
    ...
    this.SCE_CONTEXTS = ga;var a = ["self"],
      ...
      function c(a, b) {
        ...
        throw Fa("unsafe");
          ...
          h = {};h[ga.HTML] = f(g);h[ga.CSS] = f(g);h[ga.URL] = f(g);h[ga.JS] = f(g);h[ga.RESOURCE_URL] = f(h[ga.URL]);return { trustAs: function trustAs(a, b) {
          ...
          if (null === f || z(f) || "" === f) return f;var g = h.hasOwnProperty(d) ? h[d] : null;if (g && f instanceof g) return f.$$unwrapTrustedValue();if (d === ga.RESOURCE_URL) {
            var g = ta(f.toString()),
                n,
                r,
                s = !1;n = 0;for (r = a.length; n < r; n++) {
              if (c(a[n], g)) {
                s = !0;break;
              }
            }if (s) for (n = 0, r = b.length; n < r; n++) {
              if (c(b[n], g)) {
                s = !1;break;
              }
    ...
    this.$get = ["$window", "$document", function (a, b) {
      ...
      }return { history: !(!c || 4 > f || e), hasEvent: function hasEvent(a) {
  ...
  function Sf() {
    ...
    var f = E(a) && d in a;!0 === b ? b = na : C(b) || (b = function b(a, _b) {
      if (z(a)) return !1;if (null === a || null === _b) return a === _b;if (E(_b) || E(a) && !Ac(a)) return !1;a = Q("" + a);_b = Q("" + _b);return -1 !== a.indexOf(_b);
    });return function (e) {
    ...
    function b(a) {
      ...
      var g = "",
          h = [],
          k,
          l;d = d || "mediumDate";d = a.DATETIME_FORMATS[d] || d;D(c) && (c = Qg.test(c) ? Z(c) : b(c));ba(c) && (c = new Date(c));if (!ja(c) || !isFinite(c.getTime())) return c;for (; d;) {
        (l = Rg.exec(d)) ? (h = cb(h, l, 1), d = h.pop()) : (h.push(d), d = null);
      }var m = c.getTimezoneOffset();e && (m = Dc(e, m), c = Ub(c, e, !0));q(h, function (b) {
    ...
    };Xd({ ctrl: this, $element: a, set: function set(a, b, c) {
    ...
    var b = a.currentScript,
      ...
      Ic = !1,
      La = 3,
      Ae = { full: "1.5.11", major: 1, minor: 5, dot: 11, codeName: "princely-quest" };W.expando = "ng339";var jb = W.cache = {},
    ...
    return !!(this.compareDocumentPosition(a) & 16);
      ...
      Pa = W.prototype = { ready: function ready(a) {
      function b() {
        d || (d = !0, a());
    ...
    ngMin: "min", ngMax: "max", ngPattern: "pattern" };q({ data: $b, removeData: ib, hasData: function hasData(a) {
    ...
    W[b] = a;
  });q({ data: $b, inheritedData: Eb, scope: function scope(a) {
    ...
    }, controller: Xc, injector: function injector(a) {
    ...
    W.prototype[b] = function (b, c) {
      var f,
        ...
        if (E(b)) {
          for (f = 0; f < g; f++) {
            if (a === $b) a(this[f], b);else for (e in b) {
              a(this[f], e, b[e]);
            }
          }return this;
  ...
  });q({ removeData: ib, on: function on(a, b, d, c) {
      if (x(c)) throw Yb("onargs");if (Sc(a)) {
        c = zb(a, !0);var f = c.events,
            e = c.handle;e || (e = c.handle = dg(a, f));c = 0 <= b.indexOf(" ") ? b.split(" ") : [b];for (var g = c.length, h = function h(b, c, g) {
    ...
    }, clone: Zb, triggerHandler: function triggerHandler(a, b, d) {
      var c,
          f,
          e = b.type || b,
    ...
    W.prototype[b] = function (b, c, f) {
      for (var e, g = 0, h = this.length; g < h; g++) {
        z(e) ? (e = a(this[g], b, c, f), x(e) && (e = F(e))) : Vc(e, a(this[g], b, c, f));
      }return x(e) ? e : this;
    };
  });W.prototype.bind = W.prototype.on;W.prototype.unbind = W.prototype.off;Sa.prototype = { put: function put(a, b) {
  ...
  Kc.$inject = ["$provide", "$$sanitizeUriProvider"];Hb.prototype.isFirstChange = function () {
    ...
    this.$get = ["$window", function (a) {
      ...
      lb = G("$location"),
      vg = /^\s*[\\/]{2,}/,
      ah = { $$absUrl: "", $$html5: !1, $$replace: !1, absUrl: Ib("$$absUrl"), url: function url(a) {
  ...
  q([rd, kc, jc], function (a) {
    ...
    Qb[a] = !0;
      ...
      mc = function mc(a) {
    this.options = a;
  };mc.prototype = { constructor: mc, lex: function lex(a) {
      this.text = a;this.index = 0;for (this.tokens = []; this.index < this.text.length;) {
        if (a = this.text.charAt(this.index), '"' === a || "'" === a) this.readString(a);else if (this.isNumber(a) || "." === a && this.isNumber(this.peek())) this.readNumber();else if (this.isIdentifierStart(this.peekMultichar())) this.readIdent();else if (this.is(a, "(){}[].,;:?")) this.tokens.push({ index: this.index,
    ...
    this.lexer = a;this.options = b;
      ...
      for (var a = [];;) {
        if (0 < this.tokens.length && !this.peek("}", ")", ";", "]") && a.push(this.expressionStatement()), !this.expect(";")) return { type: t.Program, body: a };
      }
    ...
    expression: function expression() {
      ...
      for (var a = this.equality(); this.expect("&&");) {
        a = { type: t.LogicalExpression, operator: "&&", left: a, right: this.equality() };
      }return a;
    }, equality: function equality() {
      for (var a = this.relational(), b; b = this.expect("==", "!=", "===", "!==");) {
        a = { type: t.BinaryExpression, operator: b.text, left: a, right: this.relational() };
      }return a;
      ...
      for (var a = this.multiplicative(), b; b = this.expect("+", "-");) {
        a = { type: t.BinaryExpression, operator: b.text, left: a, right: this.multiplicative() };
      }return a;
    }, multiplicative: function multiplicative() {
      for (var a = this.unary(), b; b = this.expect("*", "/", "%");) {
        a = { type: t.BinaryExpression, operator: b.text, left: a, right: this.unary() };
      }return a;
    ...
    primary: function primary() {
      ...
      a = [a];for (var b = { type: t.CallExpression, callee: this.identifier(), arguments: a, filter: !0 }; this.expect(":");) {
    ...
    }, selfReferential: { "this": { type: t.ThisExpression }, $locals: { type: t.LocalsExpression } } };Gd.prototype = { compile: function compile(a, b) {
      var d = this,
    ...
    getStringValue: function getStringValue(a) {
    ...
    } };Hd.prototype = { compile: function compile(a, b) {
      var d = this,
      ...
      var c,
          ...
          return g = [], q(a.arguments, function (a) {
            ...
            var n = f(a, c, d, m),
                r;if (null != n.value) {
              Ea(n.context, e.expression);td(n.value, e.expression);r = [];for (var s = 0; s < g.length; ++s) {
          ...
          return g = [], q(a.properties, function (a) {
            ...
            for (var f = {}, r = 0; r < g.length; ++r) {
              g[r].computed ? f[g[r].key(a, c, d, e)] = g[r].value(a, c, d, e) : f[g[r].key] = g[r].value(a, c, d, e);
            }return b ? { value: f } : f;
  ...
  Pd.$inject = ["$locale"];var Sg = { yyyy: U("FullYear", 4, 0, !1, !0), yy: U("FullYear", 2, 0, !0, !0), y: U("FullYear", 1, 0, !1, !0), MMMM: nb("Month"), MMM: nb("Month", !0), MM: U("Month", 2, 1), M: U("Month", 1, 1), LLLL: nb("Month", !1, !0), dd: U("Date", 2), d: U("Date", 1), HH: U("Hours", 2), H: U("Hours", 1), hh: U("Hours", 2, -12), h: U("Hours", 1, -12), mm: U("Minutes", 2), m: U("Minutes", 1), ss: U("Seconds", 2), s: U("Seconds", 1), sss: U("Milliseconds", 3), EEEE: nb("Day"), EEE: nb("Day", !0), a: function a(_a, b) {
  ...
  });var Nb = { $addControl: w, $$renameControl: function $$renameControl(a, b) {
      a.$name = b;
    }, $removeControl: w, $setValidity: w, $setDirty: w, $setPristine: w, $setSubmitted: w };Wd.$inject = ["$element", "$attrs", "$scope", "$animate", "$interpolate"];var ee = function ee(a) {
    return ["$timeout", "$parse", function (b, d) {
      function c(a) {
        return "" === a ? d('this[""]').assign : d(a).assign || w;
      }return { name: "form", restrict: a ? "EAC" : "E", require: ["form", "^^?form"], controller: Wd, compile: function compile(d, e) {
          d.addClass(Wa).addClass(rb);var g = e.name ? "name" : a && e.ngForm ? "ngForm" : !1;return { pre: function pre(a, d, e, f) {
    ...
    Yd[a] = !0;
  });var je = { text: function text(a, b, d, c, f, e) {
      Xa(a, b, d, c, f, e);sc(c);
    ...
    }, "yyyy-Www"), month: ob("month", he, Pb(he, ["yyyy", "MM"]), "yyyy-MM"), number: function number(a, b, d, c, f, e) {
    ...
    return { restrict: "E", require: ["?ngModel"], link: { pre: function pre(f, e, g, h) {
      ...
      gf = function gf() {
    return { restrict: "A",
      priority: 100, compile: function compile(a, b) {
    ...
    link: function link(a, b, d, c) {
      ...
      Me = vc("Odd", 0),
      Le = vc("Even", 1),
      Ne = Va({ compile: function compile(a, b) {
    ...
    return { restrict: "ECA",
      ...
      Te = Va({ priority: 450, compile: function compile() {
    ...
    this.$asyncValidators = {};this.$parsers = [];this.$formatters = [];this.$viewChangeListeners = [];this.$untouched = !0;this.$touched = !1;this.$pristine = !0;this.$dirty = !1;this.$valid = !0;this.$invalid = !1;this.$error = {};this.$$success = {};this.$pending = void 0;this.$name = l(d.name || "", !1)(a);this.$$parentForm = Nb;var m = f(d.ngModel),
      ...
      if ((p.$options = a) && a.getterSetter) {
        var b = f(d.ngModel + "()"),
            e = f(d.ngModel + "($$$p)");r = function r(a) {
          var c = m(a);C(c) && (c = b(a));
          return c;
        };s = function s(a, b) {
          C(m(a)) ? e(a, { $$$p: b }) : n(a, b);
    ...
    };var y = 0;Xd({ ctrl: this, $element: c, set: function set(a, b) {
        a[b] = !0;
      ...
      var b = p.$$lastCommittedViewValue;if (u = z(b) ? void 0 : !0) for (var c = 0; c < p.$parsers.length; c++) {
      ...
      var b = r(a);if (b !== p.$modelValue && (p.$modelValue === p.$modelValue || b === b)) {
        p.$modelValue = p.$$rawModelValue = b;u = void 0;for (var c = p.$formatters, d = c.length, e = b; d--;) {
          e = c[d](e);
    ...
    return { restrict: "A",
      require: ["ngModel", "^?form", "^?ngModelOptions"], controller: gh, priority: 1, compile: function compile(b) {
        b.addClass(Wa).addClass("ng-untouched").addClass(rb);return { pre: function pre(a, b, f, e) {
    ...
    function c(a, b, c) {
      function e(a, b, c, d, f) {
        ...
        e = y.document.createElement("optgroup");return { restrict: "A", terminal: !0, require: ["select", "ngModel"], link: { pre: function pre(a, b, c, d) {
          ...
          function m(a, b) {
            ...
            var a = w && r.readValue();if (w) for (var b = w.items.length - 1; 0 <= b; b--) {
              ...
              s = l[1],
              t = k.multiple,
              u;l = 0;for (var p = h.children(), z = p.length; l < z; l++) {
            if ("" === p[l].value) {
              u = p.eq(l);break;
            }
          }var A = !!u,
    ...
    var c = G("ngRepeat"),
      ...
      transclude: "element", priority: 1E3, terminal: !0, $$tlb: !0, compile: function compile(e, g) {
        var h = g.ngRepeat,
            ...
            A,
            v,
            w = { $id: Aa };s ? p = a(s) : (A = function A(a, b) {
          return Aa(b);
        }, v = function v(a) {
          return a;
        });return function (a, d, e, g, l) {
          p && (x = function x(b, c, d) {
            ...
            var g,
                ...
                F,
                E,
                G;r && (a[r] = e);if (la(e)) F = e, n = x || A;else for (G in n = x || v, F = [], e) {
              ua.call(e, G) && "$" !== G.charAt(0) && F.push(G);
            }z = F.length;G = Array(z);for (g = 0; g < z; g++) {
              if (y = e === F ? g : F[g], C = e[y], D = n(y, C, g), m[D]) E = m[D], delete m[D], w[D] = E, G[g] = E;else {
                if (w[D]) throw q(G, function (a) {
                  a && a.scope && (m[a.id] = a);
                }), c("dupes", h, D, C);G[g] = { id: D, scope: void 0, clone: void 0 };w[D] = !0;
              }
            }for (s in m) {
              E = m[s];D = vb(E.clone);b.leave(D);if (D[0].parentNode) for (g = 0, n = D.length; g < n; g++) {
                D[g].$$NG_REMOVED = !0;
              }E.scope.$destroy();
            }for (g = 0; g < z; g++) {
              if (y = e === F ? g : F[g], C = e[y], E = G[g], E.scope) {
                s = p;do {
                  s = s.nextSibling;
                } while (s && s.$$NG_REMOVED);E.clone[0] !== s && b.move(vb(E.clone), null, p);p = E.clone[E.clone.length - 1];f(E.scope, g, t, C, u, y, z);
              } else l(function (a, c) {
    ...
    return { require: "ngSwitch", controller: ["$scope", function () {
      ...
      $e = Va({ transclude: "element", priority: 1200, require: "^ngSwitch", multiElement: !0, link: function link(a, b, d, c, f) {
    ...
    priority: 1200, require: "^ngSwitch", multiElement: !0, link: function link(a, b, d, c, f) {
